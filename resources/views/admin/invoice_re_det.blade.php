...
<div class="card card-secondary">
  <div class="card-header">
    ...
    <form action="{{route('admin.invoice_re_det.insert1',$data1->id_invoice_re)}}" method="POST">
      @csrf
     <div class="card-body">
      <div class="row">
        <div class="col-2">
            <label for="exampleInputEmail1">رقم الفاتورة:</label>
          <input type="number" value="{{$data1->id_invoice_re}}" class="form-control" name="id_invoice"  placeholder=" " disabled >
        </div>
        <div class="col-md-4">
...
<div class="card">
  <div class="card-header">
    ...
    @if(@isset($data2))
    <a href="{{ route('print.invoice_re_print',$data1->id_invoice_re) }}" class="btn btn-primary">طباعة</a>
    @endif
  </div>
  <!-- /.card-header -->
  <div class="card-body">
